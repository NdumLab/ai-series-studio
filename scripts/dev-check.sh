...
"${PYTHON_BIN}" -m pytest backend/tests/test_provider_layer.py backend/tests/test_phase2b_llm.py backend/tests/test_auth_helpers.py backend/tests/test_credit_utils.py
